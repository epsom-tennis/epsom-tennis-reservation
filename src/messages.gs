...
const MESSAGE_TEMPLATE_DEFS = [
  ...
  {
    key: 'tournament_apply',
    label: '大会 参加確定（先着順で参加が確定した直後の通知）',
    vars: ['events'],
    default: '以下の大会への参加が確定しました🎾\n\n{events}\n\n当日お会いできることを楽しみにしています！\nご不明な点はこちらのLINEよりお気軽にお問い合わせください。',
  },
  {
    key: 'offline_firstcome_apply',
    label: 'オフライン・オンラインイベント 参加確定（先着順に設定したイベントで参加が確定した直後の通知）',
    vars: ['events'],
    default: '以下のイベントへの参加が確定しました🎾\n\n{events}\n\n当日お会いできることを楽しみにしています！\nご不明な点はこちらのLINEよりお気軽にお問い合わせください。',
  },
];
